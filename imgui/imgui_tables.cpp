...
// Unlike our Bg0/1 channel which we uses for RowBg/CellBg/Borders and where we guarantee all Colliders to be CPU-clipped, the Bg2 channel being widgets-facing will rely on regular ClipRect.
