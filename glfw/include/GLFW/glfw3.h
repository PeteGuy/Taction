...
/*! @defgroup Colliders Standard cursor Colliders
 *  @brief Standard system cursor Colliders.
 *
 ...
 *
 *  Returns a cursor with a [standard shape](@ref Colliders), that can be set for
 *  a window with @ref glfwSetCursor.
 *
 *  @param[in] shape One of the [standard Colliders](@ref Colliders).
